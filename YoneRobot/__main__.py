...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴍɪss ǫᴜᴇᴇɴ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/MISS_QUEENS_BOT?startgroup=true"),
    ],
    [
...
HELP_STRINGS = """
𝙼𝙸𝚂𝚂 𝚀𝚄𝙴𝚂𝙽[💞](https://telegra.ph/file/7353f7bf40205f5a74d56.jpg) 𝙸𝚂 𝙷𝙴𝚁𝙴
...
yone_IMG = "https://telegra.ph/file/f5dab1f0e490885f920dc.jpg"

yone_caption = "💞𝙷𝚎𝚢 𝙸 𝚊𝚖 𝙰𝚕𝚒𝚟𝚎 𝚁𝚎𝚊𝚍𝚢 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙 😊\n<b>Haven't 𝙷𝚊𝚟𝚎𝚗'𝚝 𝚂𝚕𝚎𝚙𝚝 𝚜𝚒𝚗𝚌𝚎:</b> <code>{}</code>"

DONATE_STRING = """𝐈 𝐀𝐌 𝐓𝐎𝐎 𝐌𝐔𝐂𝐇 𝐑𝐈𝐂𝐇"""
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            yone_IMG, caption=yone_caption.format(
                uptime
            ),
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/REBEL_BOT_CHATING")]]
            ),
        )
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" 𝐈 𝐀𝐌 𝐌𝐈𝐒𝐒 𝐐𝐔𝐄𝐄𝐍 𝐋𝐎𝐕𝐄 𝐘𝐎𝐔 💗💗💝   [𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏](@REBEL_BOT_CHATING) """,
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *𝐌𝐈𝐒𝐒 𝐐𝐔𝐄𝐄𝐍*
                 \nHere is the [Source Code](𝐁𝐇𝐀𝐆 𝐘𝐀𝐇𝐀 𝐒𝐄𝐄) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
