...
import html
import requests
import YoneRobot.modules.sql.kuki_sql as sql

from time import sleep
from telegram import ParseMode
from YoneRobot import dispatcher, updater, SUPPORT_CHAT
...
from YoneRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                " 𝙲𝙷𝙰𝚃𝙱𝙾𝚃 𝙳𝙸𝚂𝙰𝙱𝙻𝙴 𝙱𝚈  {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "𝙼𝙸𝚂𝚂 𝚀𝚄𝙴𝙴𝙽 𝙲𝙷𝙰𝚃𝙱𝙾𝚃 𝙴𝙽𝙰𝙱𝙻𝙴 𝙱𝚈  {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
